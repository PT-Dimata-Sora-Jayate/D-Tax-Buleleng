<%-- 
    Document   : login_new
    Created on : Mar 11, 2015, 5:20:37 PM
    Author     : dimata005
--%>
...
if(iCommand==CMD_LOGIN){
	...
	com.dimata.saras.session.admin.SessUserSession  userSess = new com.dimata.saras.session.admin.SessUserSession(remoteIP );
...
for (Path root : FileSystems.getDefault().getRootDirectories()) {
    ...
    try {
        ...
        System.out.println("available=" + nf.format(store.getUsableSpace() / mb) + " MB"
...
<html >
    ...
    <body class="bg-olive-">
        ...
        <div class="form-box" id="login-box">
            ...
            <div class="header"><center><img src="imgcompany/dimata_system_logo.png" width="250" border="none" /></center></div>
