...
<%@page import="com.dimata.webclient.EchoTagihanDeleteInstansi"%>
...
<% //proses yang tidak akan ditampilkan hanya diserver side
    ...
    switch (iCommand) {
        ...
        case Command.START:
            ...
            EchoTagihanDeleteInstansi echoTagihanDeleteInstansi = new EchoTagihanDeleteInstansi();
            String code = echoTagihanDeleteInstansi.action(tagihanDeleteInstansi);
            if(code.equals("00")){
                result = "Transaksi berhasil di Hapus";
                ...
                if(code.equals("03")){
                    result="Transaksi Gagal di Hapus";
                }else if(code.equals("02")){
                    result="Data Tidak Ditemukan";
                }else{
                    result="Tidak Memiliki Wewenang Akses";
                }
            }
            ...
            fileSent.setLocation(AppSetting.PBB_LOCATION_FILE+"\\"+year+"\\"+strMonth+"\\"+Formater.formatDate(transaksiCreate, "yyyyMMdd"));
            fileSent.setFileName(AppSetting.INSTANSI_PBB+"_"+Formater.formatDate(transaksiCreate, "yyyy-MM-dd_HHmm")+"");
            fileSent.setFileNameZip(AppSetting.INSTANSI_PBB+"_"+Formater.formatDate(transaksiCreate, "yyyy-MM-dd_HHmm")+".zip");
...
<html>
    <head>
        ...
        <script language="JavaScript">
            <%
                if(DTaxManagerPbb.running == true){
            %>
                    setTimeout((function() {
                    window.location="pbb.jsp?menu=0";
                    }), 8000);
            <%
                }
            %>
                                    ...
                                    <div class="box-header">
                                        <div class="col-xs-12"><label>Monitoring PBB Service</label>
                                            <table width="85%" border="0" cellspacing="1" cellpadding="1" align="center">
                                                ...
                                                <tr> 
                                                    <td colspan="3" class="title">Proses Hapus Data Instansi  : <%=result%></td>
                                                </tr>
                                                <tr> 
