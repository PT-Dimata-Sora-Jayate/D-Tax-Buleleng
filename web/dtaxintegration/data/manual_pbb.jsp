<%--  
    ...
    Author     : dimata005
--%>
<%@page import="com.dimata.util.ChekPenghilanganPiutang"%>
<%@page import="com.dimata.util.ChekPiutang"%>
    ...
    public static Vector getListPBBV2(String where) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                ChekPenghilanganPiutang jumlahDiskon = new ChekPenghilanganPiutang();
//                if (Integer.valueOf(pbb.getTahun()) == 2019){
...
//                }
               ...
               if (Integer.valueOf(pbb.getTahun()) <= 2018){
               if(chek.chekPenghilangan(pbb.getId(),Integer.valueOf(pbb.getTahun()))){
                    continue;
                }
                }
...
<% //proses yang tidak akan ditampilkan hanya diserver side
    ...
    //penyesuaian diskon 50%
//    whereClause = " WHERE NOP='" + sNoId + "' AND tahun BETWEEN 2019 AND 2024";
    whereClause = " WHERE NOP='"+sNoId+"' ";//PstPaymentPhr.fieldNames[PstPaymentPhr.FLD_TANGGAL]+" = TO_DATE ('"+oDate+"','YYYY-MM-DD HH24:MI:SS')";
    //whereClause += " AND THN_PAJAK_SPPT BETWEEN '2021' AND '2025' ";//PstPaymentPhr.fieldNames[PstPaymentPhr.FLD_TANGGAL]+" = TO_DATE ('"+oDate+"','YYYY-MM-DD HH24:MI:SS')";
    listTagihanPbb = getListPBBV2(whereClause);
    
    //default
//    whereClause = " WHERE NOP='"+sNoId+"' ";//PstPaymentPhr.fieldNames[PstPaymentPhr.FLD_TANGGAL]+" = TO_DATE ('"+oDate+"','YYYY-MM-DD HH24:MI:SS')";
//    whereClause += " AND THN_PAJAK_SPPT BETWEEN '2021' AND '2025' ";
//    listTagihanPbb = SessSimpatda.getListPBBV2(whereClause);
