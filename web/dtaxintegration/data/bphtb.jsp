...
<%@page import="com.dimata.dtaxintegration.session.DTaxManagerBphtb"%>
...
<% //proses yang tidak akan ditampilkan hanya diserver side
    ...
    switch (iCommand) {
        ...
        case Command.START:
            ...
            fileSent.setsUser(AppSettingBphtb.USERNAME_BPHTB);//1
            fileSent.setsPassword(AppSettingBphtb.PWD_BPHTB);//2
            fileSent.setsInstansi(AppSettingBphtb.INSTANSI_BPHTB);//6
            fileSent.setLocation(AppSettingBphtb.BPHTB_LOCATION_FILE+"\\"+year+"\\"+strMonth+"\\"+Formater.formatDate(transaksiCreate, "yyyyMMdd"));
            fileSent.setFileName(AppSettingBphtb.INSTANSI_BPHTB+"_"+Formater.formatDate(transaksiCreate, "yyyy-MM-dd_HHmm")+"");
            fileSent.setFileNameZip(AppSettingBphtb.INSTANSI_BPHTB+"_"+Formater.formatDate(transaksiCreate, "yyyy-MM-dd_HHmm")+".zip");

			//Buat directory tahun kalau gak ada
			Path path = Paths.get(fileSent.getLocation());
			...
			dTaxManagerBphtb.startTransfer(fileSent);
			
            break;

        case Command.STOP:

            dTaxManagerBphtb.stopMonitor();

            break;

    }
    boolean running = dTaxManagerBphtb.getStatus();
%>
<html>
    <head>
        <meta charset="UTF-8">
        ...
        <script language="JavaScript">
            ...
            function cmdPrint(){
                var myWindow = window.open("proses_bphtb.jsp", "MsgWindow", "toolbar=no, scrollbars=yes, resizable=yes, top=500, left=500, width=500, height=500");
                if (window.focus) 
                {
                    myWindow.focus();
                }
             ...
             function cmdStart(){
                ...
                document.driver.action="bphtb.jsp";
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box">
                                    ...
                                    <div class="box-header">
                                        <div class="col-xs-12"><label>Monitoring BPHTB Service</label>
                                            <table width="85%" border="0" cellspacing="1" cellpadding="1" align="center">
                                                <tr> 
                                                    <td colspan="3" class="title"><b>Jumlah Yang Sudah ke Temporary : <%=dTaxManagerBphtb.getCountQuery()%> / <%=dTaxManagerBphtb.getCountTotal()%></b></td>
                                                </tr>
                                                <tr> 
                                                    <td colspan="3" class="title"><b>Jumlah Yang Sudah ke File Data : <%=dTaxManagerBphtb.getCount()%> / <%=dTaxManagerBphtb.getCountTotal()%></b></td>
                                                </tr>
                                                <tr> 
                                                    <td colspan="3" class="title"><b>Status <%=dTaxManagerBphtb.getStart()%> / <%=dTaxManagerBphtb.getEnd()%></b></td>
                                                </tr>
                                                 <tr> 
                                                    <td colspan="3" class="title"><b>Message <%=dTaxManagerBphtb.getProses() %></b></td>
                                                </tr>
                                                <tr> 
                                                    <td width="40%">&nbsp;</td>
                                                    <td width="4%">&nbsp;</td>
