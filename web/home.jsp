<%-- 
    ...
    Author     : dimata005
--%>
<%@page import="com.dimata.webclient.bphtb.EchoTestBphtb"%>
    ...
    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <center>
                Selamat Datang <br>
                <!--<h4>Aplikasi Untuk Tes</h4>-->
                <br>
                <%
                    EchoTest echo = new EchoTest();
                    EchoTestBphtb echoBphtb = new EchoTestBphtb();
                %><br><br><br><br>
                KONEKSI KE BANK BPD DENGAN STATUS : <%=echo.action()%></b><br>
                KONEKSI BPHTB KE BANK BPD DENGAN STATUS : <b><%=echoBphtb.action()%></b>
                </center>
            </aside><!-- /.right-side -->
        </div><!-- ./wrapper -->
