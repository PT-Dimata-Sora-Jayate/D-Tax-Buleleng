...
public class report_retribusi_global_pdf extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        listPayment = PstPaymentRetribusi.listSum(0, 0, whereClause, "");
    ...
    public static Table getTitle(String startDate, String startEnd) {
        ...
        try {
            ...
            //--
            cnt = new Cell(new Chunk("LAPORAN PENERIMAAN GLOBAL PAJAK RETRIBUSI ", fontHeaderBig));
...
//                content.addCell(cnt);
    ...
    public static Table getHeader() throws Exception {
        ...
        cnt = new Cell(new Chunk("TOTAL SETORAN", fontContentSmall));
