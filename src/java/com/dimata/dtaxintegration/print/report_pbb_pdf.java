...
public class report_pbb_pdf  extends HttpServlet {
    ...
    public static Table getTitle(String startDate, String startEnd) {
        ...
        try {
            ...
            //--
            cnt = new Cell(new Chunk("LAPORAN PENERIMAAN DETAIL HARIAN PAJAK PBB ", fontHeaderBig));
            ...
            if (result != null && result.size() > 0) {
                ...
                for (int i = 0; i < result.size(); i++) {
                    ...
                    try {
                        ...
                        cnt = new Cell(new Chunk("" +paymentPbb.getNop(), fontContentSmall));//3
                        ...
                        cnt = new Cell(new Chunk("" +paymentPbb.getThnPajakSppt(), fontContentSmall));//4
                        ...
                        cnt = new Cell(new Chunk("" + paymentPbb.getStatus(), fontContentSmall));//5
...
//                content.addCell(cnt);
                ...
                cnt = new Cell(new Chunk("", fontContentSmall));//5
    ...
    public static Table getHeader() throws Exception {
        ...
        int contentWith[] = {5,20,20,25,20,10};

        Table content = new Table(6);
        ...
        cnt = new Cell(new Chunk("NOP", fontContentSmall));
        ...
        cnt = new Cell(new Chunk("TAHUN", fontContentSmall));
        ...
        cnt = new Cell(new Chunk("STATUS", fontContentSmall));
