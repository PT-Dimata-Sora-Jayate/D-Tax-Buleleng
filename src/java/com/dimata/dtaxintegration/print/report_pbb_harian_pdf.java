...
public class report_pbb_harian_pdf extends HttpServlet{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        listPayment = PstPaymentPbb.list(0, 0, whereClause, 
            ...
            ""+PstPaymentPbb.fieldNames[PstPaymentPbb.FLD_TGLPEMBAYARANSPPT]);
    ...
    public static Table getTitle(String startDate, String startEnd) {
        ...
        try {
            ...
            //--
            cnt = new Cell(new Chunk("LAPORAN PENERIMAAN TOTAL HARIAN PAJAK BUMI DAN BANGUNAN ", fontHeaderBig));
