...
public class report_pbb_bulanan_pdf extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        listPayment = PstPaymentPbb.listPerBulan(0, 0, whereClause, 
                    ""+PstPaymentPbb.fieldNames[PstPaymentPbb.FLD_TGLPEMBAYARANSPPT]+" ASC ", 
                    "TO_CHAR("+PstPaymentPbb.fieldNames[PstPaymentPbb.FLD_TGLPEMBAYARANSPPT]+",'Month YYYY')");
    ...
    public static Table getTitle(String startDate, String startEnd) {
        ...
        try {
            ...
            Cell cnt = new Cell(new Chunk("DISPENDA BULELENG", fontHeaderBig));
            ...
            //--
            cnt = new Cell(new Chunk("LAPORAN PENERIMAAN TOTAL BULANAN PAJAK BUMI DAN BANGUNAN ", fontHeaderBig));
            ...
            if (result != null && result.size() > 0) {
                ...
                for (int i = 0; i < result.size(); i++) {
                    ...
                    try {
                        ...
                        cnt = new Cell(new Chunk("" + Formater.formatDate(paymentPbb.getTglPembayaranSppt(), "dd-MMM-yy").toUpperCase(), fontContentSmall));//2
                        ...
                        double pokok = paymentPbb.getJmlSpptYgDibayar() - paymentPbb.getDendaSppt();
                        ...
                        cnt = new Cell(new Chunk("" + Formater.formatNumber(paymentPbb.getDendaSppt(), "#,###"), fontContentSmall));//4
                        ...
                        cnt = new Cell(new Chunk("" + Formater.formatNumber(paymentPbb.getJmlSpptYgDibayar(), "#,###"), fontContentSmall));//5
                        ...
                        totalDenda = totalDenda + paymentPbb.getDendaSppt();
...
//                content.addCell(cnt);
                ...
                cnt = new Cell(new Chunk("" + Formater.formatNumber(totalPokok, "#,###"), fontContentSmall));//3
                ...
                cnt = new Cell(new Chunk("" + Formater.formatNumber(totalDenda, "#,###"), fontContentSmall));//4
    ...
    public static Table getHeader() throws Exception {
        ...
        cnt = new Cell(new Chunk("TANGGAL", fontContentSmall));
