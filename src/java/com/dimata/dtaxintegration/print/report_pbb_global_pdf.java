...
public class report_pbb_global_pdf extends HttpServlet{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        listPayment = PstPaymentPbb.listSum(0, 0, whereClause, "");
    ...
    public static Table getTitle(String startDate, String startEnd) {
        ...
        try {
            ...
            //--
            cnt = new Cell(new Chunk("LAPORAN PENERIMAAN GLOBAL PAJAK PBB ", fontHeaderBig));
            ...
            if (result != null && result.size() > 0) {
                ...
                for (int i = 0; i < result.size(); i++) {
                    ...
                    try {
                        ...
                        denda=denda+paymentPbb.getDendaSppt();
                        ...
                        cnt = new Cell(new Chunk("" +Formater.formatNumber(paymentPbb.getDendaSppt(),"#,###"), fontContentSmall));//2
                        ...
                        cnt = new Cell(new Chunk("" +Formater.formatNumber(paymentPbb.getJmlSpptYgDibayar(),"#,###"), fontContentSmall));//3
...
//                content.addCell(cnt);
                    ...
                    Cell cnt = new Cell(new Chunk(" TOTAL ", fontContentSmall));//1
                    ...
                    cnt = new Cell(new Chunk("" +Formater.formatNumber(denda,"#,###"), fontContentSmall));//2
                    ...
                    cnt = new Cell(new Chunk("" +Formater.formatNumber(total,"#,###"), fontContentSmall));//3
