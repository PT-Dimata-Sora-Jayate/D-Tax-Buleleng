...
public class report_bphtb_pdf extends HttpServlet {
    ...
    public static Table getTitle(String startDate, String startEnd) {
        ...
        try {
            ...
            //--
            cnt = new Cell(new Chunk("LAPORAN PENERIMAAN DETAIL HARIAN PAJAK BPHTB ", fontHeaderBig));
            ...
            if (result != null && result.size() > 0) {
                ...
                for (int i = 0; i < result.size(); i++) {
                    ...
                    try {
                        ...
                        cnt = new Cell(new Chunk("" +paymentBphtb.getNoTib(), fontContentSmall));//3
                        ...
                        cnt = new Cell(new Chunk("" +Formater.formatNumber(paymentBphtb.getJumlahBayar(),"#,###"), fontContentSmall));//4
                        ...
                        cnt = new Cell(new Chunk("" + paymentBphtb.getStatus(), fontContentSmall));//5
...
//                content.addCell(cnt);
                    ...
                    cnt = new Cell(new Chunk(" TOTAL ", fontContentSmall));//3
                    ...
                    cnt = new Cell(new Chunk("" +Formater.formatNumber(total,"#,###"), fontContentSmall));//4
    ...
    public static Table getHeader() throws Exception {
        ...
        cnt = new Cell(new Chunk("TIB", fontContentSmall));
