...
public class PstLogHistoryTransaksi extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static LogHistoryTransaksi fetchExc(long oid) throws DBException {
        try {
            ...
            entLogHistoryTransaksi.setId(pstLogHistoryTransaksi.getString(FLD_ID));
    ...
    public static synchronized long updateExc(LogHistoryTransaksi entLogHistoryTransaksi) throws DBException {
        try {
            if (entLogHistoryTransaksi.getOID() != 0) {
                ...
                pstLogHistoryTransaksi.setString(FLD_ID, entLogHistoryTransaksi.getId());
    ...
    public static void resultToObject(ResultSet rs, LogHistoryTransaksi entLogHistoryTransaksi) {
        ...
        try {
            ...
            entLogHistoryTransaksi.setId(rs.getString(PstLogHistoryTransaksi.fieldNames[PstLogHistoryTransaksi.FLD_ID]));
    ...
    public static int deleteloghistoryperinstansi(String instansi) {
      int iResult = 0;
      DBResultSet dbrs = null;
      String stSql = "";
      if (!instansi.equals("")) {
         stSql = "DELETE FROM LOG_HISTORY_TRANSAKSI WHERE " + fieldNames[FLD_INSTANSI] + " = '" + instansi + "'";
