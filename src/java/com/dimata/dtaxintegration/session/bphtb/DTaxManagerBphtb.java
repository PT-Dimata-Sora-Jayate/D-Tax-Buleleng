...
import com.dimata.dtaxintegration.session.bphtb.DTaxMonitorBphtb;
...
public class DTaxManagerBphtb {
    ...
    public static String prosesData = "";
    ...
    public static void startTransfer(FileSent fileSent) {
        ...
        DTaxManagerBphtb objMan = new DTaxManagerBphtb();
        Thread thLocker = new Thread((Runnable)new DTaxMonitorBphtb(fileSent));
        thLocker.setDaemon(false);
        running = true;
        count = 0;
        thLocker.start();
    ...
    public static String getProsesData() {
        return prosesData;
    }
    public static void setProsesData(String aProsesData) {
        prosesData = aProsesData;
    }
    
    public static String getStatusAutoUpload() {
        return statusAutoUpload;
    }
    public static void setStatusAutoUpload(String statusAutoUpload) {
        statusAutoUpload = statusAutoUpload;
    }
}