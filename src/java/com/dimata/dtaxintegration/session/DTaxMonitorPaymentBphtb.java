    ...
    public void run() {
        ...
        while (DTaxIntegrationManagerPaymentBphtb.running) {
            ...
            try {
				...
				dTaxIntegrationMonitor.inputPaymentBphtbIprotax(prevDate, "");
                dTaxIntegrationMonitor.inputPaymentBphtbIprotax(startDate, "");
                
                Thread.sleep((long) (1 * 60000));//milisecond tiap 4 jam = 240 menit
